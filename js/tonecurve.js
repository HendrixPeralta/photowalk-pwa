...
import { joinSentences } from './interpret.js';
...
function measuredSummary() {
  ...
  if (steepest) parts.push(t("The curve climbs fastest through the {band}, so that's where the photo shows the most detail.", { band: t(steepest) }));
