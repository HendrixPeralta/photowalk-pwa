...
export const TOOL_HELP = {
  gamut: {
    ...
    refs: [
      ...
      { text: 'Josef Albers, "Interaction of Color"', note: 'short and visual, showing how colours change depending on what\'s next to them' },
  ...
  vectorscope: {
    ...
    bad: "Colour pushed all the way out to the edge of the circle in one direction. That's a sign of oversaturated, clipped colour, common with the punchy processing some phone cameras apply automatically.",
    refs: [
  ...
  cie: {
    ...
    bad: "Colours scattered evenly all over the map with no real grouping. That's usually a sign of noise or a compression glitch scrambling the colours, not an actual rich, varied photo.",
    refs: [
